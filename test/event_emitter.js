(function() {
  ...
  describe('EventEmitter', function() {
    ...
    it('insure callbacks cannot disrupt event triggering', function() {
      var emitter, fn1, fn2;
      fn1 = function() {
        fn1.called += 1;
    ...
    return it('can remove all listeners', function() {
      var emitter, fn;
      fn = function() {
        return 'test';
      };
      ...
      return assert.lengthOf(emitter.getListeners('bar'), 0);
    });
  });
