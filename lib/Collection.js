(function(definition){Collection=definition(typeof(Spark)!=="undefined"?Spark:this.Spark);Collection.definition=definition;if(typeof(module)!=="undefined"&&module!==null){module.exports=Collection;}else{if(typeof(Spark)!=="undefined"&&Spark!==null){Spark.Collection=Collection;}else{if(this.Spark==null){this.Spark={};}this.Spark.Collection=Collection;}}})(function(){
var Collection,
  slice = [].slice,
